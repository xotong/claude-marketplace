...
> **Bindings not shown here:** This README covers the most common managed-agents flows for TypeScript. If you need a class, method, namespace, field, or behavior that isn't shown, refer to the SDK's official repository or documentation rather than guess. Do not extrapolate from cURL shapes or another language's SDK.
