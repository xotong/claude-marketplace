...
id: fortify-sast
category: sast
summary: Fortify SCA static analysis of source code (Maven, Gradle, Python, JavaScript, Go), with results uploaded to the GitLab Vulnerability Dashboard.
---
...
- You need results in the GitLab Vulnerability Dashboard.
